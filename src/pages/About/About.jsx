...
export const About =() =>{
    ...
    <ContentWrapper title="About">
           ...
           <section className={styles.intetproblem}>
            ...
            <div>
                <h2>VI FØLGER MED TIDEN</h2><p>Leo-lov har altid været det bedste advokatfirma i verden. Der er simpelthen ingen der kan måle sig med os. Vi kan løse alle problemer så længe du har penge. Hvis du mod alt forventning skulle oplevel at støde på et retsligt problem som leo-lov ikke kan løse får du halvdelen af beløbet igen.</p>

                </div>
            <img className={styles.karin} src={karin} alt="Money" />
           </section>
